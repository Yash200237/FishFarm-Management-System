...
namespace App.Infrastructure.Migrations
{
    ...
    [Migration("20260102031406_MakeCertifiedUntilDateOnly")]
    partial class MakeCertifiedUntilDateOnly
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Domain.Entities.FarmWorker", b =>
                {
                    ...
                    b.ToTable("FarmWorkers", null, t =>
                        {
                            t.HasCheckConstraint("CK_FarmWorkers_CertifiedUntil_FutureOrNull", "[CertifiedUntil] IS NULL OR [CertifiedUntil] >= CONVERT(date, GETUTCDATE())");
                        });
                });
